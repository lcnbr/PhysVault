...
year: 2021
---
[[zotero://select/items/@bernScalarQEDToy2021|Item]]

## Highlights:
[[@bernScalarQEDToy2021annotations]]

# Mentions:
- [[../PhysNotes/effective one body formalism]]^[[@bernScalarQEDToy2021annotations#^7e27bb]]]
- [[numerical relativity]]^[[@bernScalarQEDToy2021annotations#^ae2631]]]
- [[self-force formalism]]
- [[effective field theory]]
- [[nonrelativistic general relativity]]
- [[../PhysNotes/post-Minkowskian expansion]]^[[@bernScalarQEDToy2021annotations#^09545f]]]
- [[Newton]]
...
##  [[zotero://open-pdf/0_VLMHF4E2/2|1 Introduction]]

The landmark detection of gravitational waves \[[@bernScalarQEDToy2021annotations#^56f6bf]]]. The aim of the game is to predict gravitational wave signals. The tools used are varied but the most prominent is the [[../PhysNotes/post-Minkowskian expansion]]. On top of being useful in the [[../PhysNotes/post-Minkowskian expansion|PM expansion]] amplitudes enable the description of the hyperbolic motion of classical objects from the asymptotic past to the asymptotic future ^[[@bernScalarQEDToy2021annotations#^aa210e]]] as implemented in the [[../PhysNotes/KMOC framework]]. The usefulness of the scattering amplitude framework has been demonstrated through the first construction of the conservative two-body Hamiltonian at $\mathcal{O}(G^3)$, as well as new results at $\mathcal{O}(G^4)$^[[@bernScalarQEDToy2021annotations#^087cd9]]] .
...
All three of these approaches for extracting the classical scattering angle match, and agree with the result from the classical approach of Ref. \[[@bernScalarQEDToy2021annotations#^038ace]]]


In electromagnetism we encounter a mass singularity in the scattering angle, which does not cancel between potential and radiative contributions, as it does in the corresponding O(G3) calculation in gravity [[@bernScalarQEDToy2021annotations#^260d9e]]] we interpret this singularity as a breakdown of the classical expansion which requires $m^2 \abs{b}^2\gg 1$ 


##  [[zotero://open-pdf/0_VLMHF4E2/5|2 Review of Methods]]

#definition Two loop order: $\mathcal{O}(\alpha^3)$ where $\alpha = \frac{e^2 }{4 \pi}$ is the [[../PhysNotes/fine structure constant]]
...
- Subsection 2.5, we briefly summarize the ([[../PhysNotes/KMOC framework|KMOC]]) formalism which allows us to extract the classical electromagnetic impulse, the radiated momentum, and the classical scattering angle up to $\mathcal{O}(\alpha^3)$.

###  [[zotero://open-pdf/0_VLMHF4E2/5|2.1 Classical limit of quantum scattering amplitudes–soft and potential region]]

Relativistic scattering of two point-charges in a [[../PhysNotes/post-Lorentzian expansion|PL expansion]]^[[@bernScalarQEDToy2021annotations#^06ee81]]]. Suppose that the particles are spinless and structureless (massive [[../PhysNotes/GR/scalar fields in GR|scalar field]]). 
...
We redefine the incoming and outgoing momenta to facilitate the [[../PhysNotes/soft expansion]] (small $\abs{q}$)

$p_1 = - \pqty{\bar{p}_1-\frac{q}{2}},p_2 = - \pqty{\bar{p}_2+\frac{q}{2}},p_3 =  \pqty{\bar{p}_2-\frac{q}{2}},p_4 =  \pqty{\bar{p}_1+\frac{q}{2}}$

The barred variables are such that, for [[../PhysNotes/on-shell]] momenta ($p_i^2=m_{I_i}^2$) for $I_i=\left\{\begin{aligned}&1 \text{ for } i\in\Bqty{1,4}\\&2 \text{ for } i \in\Bqty{2,3}\end{aligned}\right.$ , $\overline{p}_I \cdot q=0$, i.e. are orthogonal to the momentum transfer $q$. 
![[../Attachements/Pasted image 20220330221749.png]]
...
###   [[\alpha^3)$](zotero://open-pdf/0_VLMHF4E2/7|2.2 Generalized Unitarity and scalar QED scattering amplitudes up to $\mathcal{O}(\alpha^3)$]]


It  is crucial to have at our disposal compact expressions for the relevant (classical parts) of the higher-loop scattering amplitudes ^[[@bernScalarQEDToy2021annotations#^5d56b7]]] and  a chief ingredient in many of these calculations is an efficient way to obtain a scattering amplitude *integrand*, i.e. an expression of the amplitude before loop integration^[[@bernScalarQEDToy2021annotations#^3d2e7b]]]: [[../PhysNotes/generalized unitarity]]. 

#### 2.2.1 Tree-level amplitudes in scalar QED ([[zotero://open-pdf/library/items/RSKAXN8Q?page=8&annotation=HEMNRTM2|pdf]])

The main building blocks of [[../PhysNotes/generalized unitarity]] are on-shell tree-level amplitudes^[[@bernScalarQEDToy2021annotations#^f5b1f0]]]
...
Where  the [[../PhysNotes/QFTII/YM covariant derivative|covariant derivative]] is that of QED: $D^\mu=\partial^\mu-\iunit\,e\,q_iA^\mu$^[[@bernScalarQEDToy2021annotations#^covDer]]where $A^\mu(x)$ is the photon field^[[@bernScalarQEDToy2021annotations#^photonField]]], $q_i$ the electric charge ^[[@bernScalarQEDToy2021annotations#^elncharge]] ] in multiples of the fundamental charge $e$^[[@bernScalarQEDToy2021annotations#^fundCharge]]]


###   [[zotero://open-pdf/0_VLMHF4E2/11|2.3 Soft and potential region expansion, IBP, and differential equations]]
        
###   [[zotero://open-pdf/0_VLMHF4E2/12|2.4 Soft radial action and master integral subtraction of classically divergent terms]]
        
###  [[zotero://open-pdf/0_VLMHF4E2/15|2.5 KMOC framework for classical conservative and radiative observables]]

Follows mainly [[@herrmannRadiativeClassicalGravitational2021]] and [[@kosowerAmplitudesObservablesClassical2019]]


## [[\alpha^3)$](zotero://open-pdf/0_VLMHF4E2/20|3 Conservative dynamics at $\mathcal{O}(\alpha^3)$]]
    
### [[zotero://open-pdf/0_VLMHF4E2/20|3.1 Conservative scattering amplitudes]]
        
### [[zotero://open-pdf/0_VLMHF4E2/21|3.2 Eikonal approach to classical conservative scattering]]
        
### [[zotero://open-pdf/0_VLMHF4E2/22|3.3 Conservative eikonal phase, scattering angle, and two-body Hamiltonian]]
        
###  [[zotero://open-pdf/0_VLMHF4E2/25|3.4 Conservative impulse and scattering angle via KMOC]]
        
## [[\alpha^3)$](zotero://open-pdf/0_VLMHF4E2/26|4 Radiative dynamics at $\mathcal{O}(\alpha^3)$]]
    
### [[zotero://open-pdf/0_VLMHF4E2/26|4.1 Radiative scattering amplitudes]]
        
### [[zotero://open-pdf/0_VLMHF4E2/27|4.2 Eikonal approach to classical scattering including radiation effects]]
        
### [[zotero://open-pdf/0_VLMHF4E2/33|4.3 Radiative impulse, energy loss, and scattering angle via KMOC]]
        
### [[zotero://open-pdf/0_VLMHF4E2/34|4.4 Radiative radial action]]
        
##  [[zotero://open-pdf/0_VLMHF4E2/35|5 Conclusions]]
